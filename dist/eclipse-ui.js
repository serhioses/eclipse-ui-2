...
var Select = function (_UI) {
  ...
  function Select(container, options) {
    ...
    _this4.drop = _this4.container.find('.sel-eui-drop');
    ...
    _this4._defaults.dropdownOptions.beforeOpen = beforeOpenDecorator(self, bO);
    ...
    if (countDisabled === _this4.items.length) {
      _this4.fullyDisabled = true;
    }

    if (_this4.highLightedIndex === undefined) {
