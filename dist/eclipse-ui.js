...
function onChange() {
  ...
  this.items.forEach(function (item, i) {
    ...
    if (radio.prop('checked')) {
      ...
      _this.valueBox.html(item.label.html());
      _this.selectedIndex = i;
      _this.highLightedIndex = i;
    } else {
      item.selected = false;
...
var Select = function (_UI) {
  ...
  function Select(container, options) {
    ...
    _this2.items = Array.prototype.map.call(_this2.container.find('.sel-eui-option'), function (option, i) {
      var radio;
    ...
    _this2.valueBox = _this2.container.find('.sel-eui-value');
    _this2.dropdown = new _dropdown2.default(_this2.container, defaults.dropdownOptions);

    if (typeof _this2.highLightedIndex === 'undefined') {
