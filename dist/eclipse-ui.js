  ...
  function Select(container, options) {
    ...
    function beforeOpenDecorator() {
      return function (a) {
        ...
        if (self.dropdown.container.offset().top > window.innerHeight / 2 + self.dropdown.container.outerHeight()) {
          cls = 'up';
        } else {
          cls = 'down';
        }
